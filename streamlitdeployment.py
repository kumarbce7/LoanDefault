...
def main():
    ...
    if st.button("Predict"):
       ...
       'LTV', 'dtir1', 'age_encoded', 'loan_type_encoded']
        ...
        data = {'loan_limit_cf': 0.34947259458873664,
        'loan_limit_missing': 1.195311983389513,
        'loan_limit_ncf': 0.8842153679043687,
        'Gender_Female': 0.303248751194062,
        'Gender_Joint': 0.42789676960024714,
        'Gender_Male': 0.24054508582829384,
        'Gender_Sex Not Available': -0.027415246624115003,
        'approv_in_adv_missing': 1.7029731009410896,
        'approv_in_adv_nopre': 0.023219518480686284,
        'approv_in_adv_pre': 0.4374647149195494,
        'total_units_1U': 1.0,
        'total_units_3U': 0.0,
        'total_units_4U': 0.0,
        'loan_purpose_p1': 0.0,
